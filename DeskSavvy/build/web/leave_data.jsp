...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
          <h1><a href="index.html"><span>DeskSavvy-</span><u> <i>Employee Leave Portal</i></u> </a></h1>
      </div>
      <div class="clr"></div>
      <div class="menu_nav">
        <ul>
      ...
      <div class="clr"></div>
       <center>
            ...
            <h2 style="color:darkmagenta;">Employee Leave data</h2>
            <div style="overflow:scroll;width: 1200px;">
            <%
           
           
            DBconnection db=new DBconnection();
            db.pstmt=db.con.prepareStatement("select * from liveapply where com_id='"+user+"' ");
             db.rst= db.pstmt.executeQuery();
             out.println("<table width=1200   bgcolor=#B9E1F5>");

out.println("<tr height=10 bgcolor=#5DD0CF>");
out.println("<td align=center><p style=color:#F66755;>Emp Id</p></td><td align=center><p style=color:#F66755;>Subject</p></td><td align=center><p style=color:#F66755;>Message</p></td><td align=center><p style=color:#F66755;>Apply Date</p></td><td align=center><p style=color:#F66755;>Action</p></td></tr>");
out.println("</tr>");
   ...
   out.println("<tr bgcolor=#DFF5E1 height=30px><td>"+user+"</td><td align=center>"+id+"</td><td align=center>"+gender+"</td><td align=center>"+phone+"</td><td align=center><a href=delete?id="+name+">Delete</a></td>");
out.println("</tr>");          
