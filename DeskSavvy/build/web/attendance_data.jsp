...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1><a href="index.html"><span>DeskSavvy</span>-  Attendance Portal</a></h1>
      </div>
      <div class="clr"></div>
      <div class="menu_nav">
        <ul>
...
out.println("</tr>");
   ...
   out.println("<tr bgcolor=#DFF5E1 height=30px><td align=center>"+cname+"</td><td align=center>"+phone+"</td><td align=center>"+gender+"</td><td align=center>"+phone+"</td><td align=center>"+gender+"</td></td>");
out.println("</tr>");          
