...
public class leave extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            db.pstmt=db.con.prepareStatement("insert into liveapply(emp_id,com_id,subject,msg,a_date) values(?,?,?,?,curdate())");
               ...
               response.sendRedirect("leave.jsp?msg=Query send Complete!!!!!!!...!!");
               }
               else
               {
               response.sendRedirect("leave.jsp?msg=errror!!!!!!...!!...!!");
