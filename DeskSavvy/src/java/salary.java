...
public class salary extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String user=(String)st.getAttribute("user1");
               ...
               db.pstmt=db.con.prepareStatement("insert into salary(empid,cid,name,dep,sal,u_data) values(?,?,?,?,?,curdate())");
   ...
   response.sendRedirect("empsal.jsp?msg=Employee Salary Update ...!!");
