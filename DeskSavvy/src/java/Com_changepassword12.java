...
public class Com_changepassword12 extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
         ...
         String old=request.getParameter("t1");
            ...
            if(db.rst.next())
            {
             ...
             if(i>0)
             {
            response.sendRedirect("CompanyChanPass11.jsp?msg=Password change successfull..");
             ...
             {
             response.sendRedirect("CompanyChanPass11.jsp?msg=Old Password not match!!!!");
             }
            }
